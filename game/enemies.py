...
def get_enemy_info():
    ...
    try:
        ...
        enemy_info = {
            ...
            guarddog: Enemy( 1, 0.08, 4,  1, 9.99, 1.40, 100,   0, 0.00, [3]),
            mutant:   Enemy(30, 0.07, 9, 10, 1.00, 1.20, 400, 180, 0.75, [1, 3]),
            officer:  Enemy(40, 0.08, 2, 10, 1.00, 1.15, 500,  90, 0.75, [2, 4]),
            ss:       Enemy(50, 0.06, 3, 15, 1.50, 1.25, 500, 180, 0.50, [3, 4, 5])
        }
        return enemy_info